# classify_v3 — per-segment classification and extraction
...
3. Cards: one per distinct idea. title ≤ 8 words in her voice; gist one sentence; play_from_ms = start of the segment;
   ...
   After a boundary marker that returns from a tangent ("anyway", "where was I", "back to it"), the speech that follows
